     ...
     switch(ID(action))	 {
        case FP_POISSON_RECON :
          ...
          //parlst.addParam(new RichBool ("UseConfidence",
            ...
            parlst.addParam(RichInt ("OctDepth",
                                            6,
                                            "Octree Depth",
            ...
            parlst.addParam(RichInt ("SolverDivide",
                                            6,
                                            "Solver Divide",
            ...
            parlst.addParam(RichFloat ("SamplesPerNode",
                                            1.0,
                                            "Samples per Node",
            ...
            parlst.addParam(RichFloat ("Offset",
                                             1.0,
                                             "Surface offsetting",
