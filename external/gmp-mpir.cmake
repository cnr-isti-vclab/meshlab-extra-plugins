...
elseif(ALLOW_BUNDLED_MPIR AND HAVE_BUNDLED_MPIR)
	...
	if (HAVE_BUNDLED_MPIR STREQUAL "WIN-x64")
		...
		target_include_directories(mpir INTERFACE ${MPIR_DIR}/inc/win32-msvc/mpir-2.2.1_x64)
	elseif(HAVE_BUNDLED_MPIR STREQUAL "APPLE-x64")
		...
		target_include_directories(mpir INTERFACE ${MPIR_DIR}/inc/macx64/mpir-2.4.0)
	endif()
